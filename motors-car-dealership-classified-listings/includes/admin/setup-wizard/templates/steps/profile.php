...
?>
	...
	<div class="mvl-welcome-nav-actions">
		<div>
			...
			$prev_step_slug = apply_filters( 'mvl_setup_wizard_prev_step', $prev_step_slug, 'profile' );
			?>
		...
		<div>
			<?php $next_step_slug = apply_filters( 'mvl_setup_wizard_next_step', 'theme', 'profile' ); ?>
