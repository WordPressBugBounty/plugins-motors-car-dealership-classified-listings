...
= 1.4.122
- **New:** Added Electric Vehicle Dealership Skin (PRO)

= 1.4.121
- **Fix:** Minor bugfixes.

= 1.4.120
- **New:** Added Dealer Two Skin (PRO)

= 1.4.119
- **New:** Added Classified Three Skin (PRO)

= 1.4.118
- **New:** Added Classified Two Skin (PRO)
...
- **New:** Added Classified Listing Skin (PRO)

= 1.4.115
- **New:** Added Rental as a new Business Type alongside Dealership and Classified, with dedicated functionality and settings in the plugin [PRO]
...
= 1.4.87
- **Bugfix:** Import starter skins

= 1.4.86 =
- **New:** Added New Premium  "Car Info Autocomplete" add-on with VIN and trim lookup via CarApi, OpenDataSoft, NHTSA, Vindecoder, and Marketcheck. [PRO]
...
- **Improvement:** Added 4 native Single Listing templates — Classic, Modern, Mosaic Gallery, and Carousel Gallery (Pro)
...
- **Fix:** Various visual fixes applied
...
- **Fix:** Migrated Sellers Note data into the listing's Description field.
...
- **Fix:** Fixed Video playback issues in Single Listings
- **Fix:** Fixed WhatsApp button not displaying in new listings
- **Fix:** Fixed users being unable to add listings via "Monetization" → "Charge for listing submissions" when "Free listing submission" is disabled
...
= 1.4.66 =
- **Enhancement:** Introduced new listing card skins in Inventory for greater customization. (Pro)
- **Enhancement:** Added a "Saved Search" email template to the Email Template Manager.
- **Fix:** Corrected an issue where the price label displayed incorrectly when it exceeded two lines in Classifieds.
- **Fix:** Resolved an issue where the "Become a Dealer" button was missing from the user profile.

= 1.4.65 =
- **Enhancement:** Moved the Enable category creation setting to the Add Listing Form.
...
- **Fix:** Fixed an issue where terms were not saved for numeric fields when added while editing a listing.
...
= 1.4.49 =
- **Enhancement:** Added image previews in the plugin settings for easier visualization.
